...
internal static unsafe class VkSurfaceUtil
{
    internal static SurfaceKHR CreateSurface(VkGraphicsDevice gd, Instance instance, SwapchainSource swapchainSource)
    {
        ...
        if (doCheck && !gd.HasSurfaceExtension(CommonStrings.VK_KHR_SURFACE_EXTENSION_NAME))
            throw new RenderException($"The required instance extension was not available: {CommonStrings.VK_KHR_SURFACE_EXTENSION_NAME}");
        ...
        switch (swapchainSource)
        {
            case XlibSwapchainSource xlibSource:
                ...
                {
                    throw new RenderException($"The required instance extension was not available: {CommonStrings.VK_KHR_XLIB_SURFACE_EXTENSION_NAME}");
                }
            ...
            case WaylandSwapchainSource waylandSource:
                ...
                {
                    throw new RenderException($"The required instance extension was not available: {CommonStrings.VK_KHR_WAYLAND_SURFACE_EXTENSION_NAME}");
                }
            ...
            case Win32SwapchainSource win32Source:
                ...
                {
                    throw new RenderException($"The required instance extension was not available: {CommonStrings.VK_KHR_WIN32_SURFACE_EXTENSION_NAME}");
                }
            ...
            case AndroidSurfaceSwapchainSource androidSource:
                ...
                {
                    throw new RenderException($"The required instance extension was not available: {CommonStrings.VK_KHR_ANDROID_SURFACE_EXTENSION_NAME}");
                }
            ...
            case NSWindowSwapchainSource nsWindowSource:
                if (doCheck)
                {
                    ...
                    {
                        throw new RenderException($"Neither macOS surface extension was available: " +
            ...
            case UIViewSwapchainSource uiViewSource:
                if (doCheck)
                {
                    ...
                    {
                        throw new RenderException($"Neither iOS surface extension was available: " +
            ...
            default:
                throw new RenderException($"The provided SwapchainSource cannot be used to create a Vulkan surface.");
        }
    }
    ...
    private static SurfaceKHR CreateWin32(VkGraphicsDevice gd, Instance instance, Win32SwapchainSource win32Source)
    {
        ...
        {
            throw new RenderException("VK_KHR_win32_surface extension not available.");
        }
    ...
    private static SurfaceKHR CreateXlib(VkGraphicsDevice gd, Instance instance, XlibSwapchainSource xlibSource)
    {
        ...
        {
            throw new RenderException("VK_KHR_xlib_surface extension not available.");
        }
    ...
    private static SurfaceKHR CreateWayland(VkGraphicsDevice gd, Instance instance, WaylandSwapchainSource waylandSource)
    {
        ...
        {
            throw new RenderException("VK_KHR_wayland_surface extension not available.");
        }
    ...
    private static unsafe SurfaceKHR CreateNSViewSurface(VkGraphicsDevice gd, Instance instance, NSViewSwapchainSource nsViewSource, bool hasExtMetalSurface)
    {
        ...
        if (hasExtMetalSurface)
        {
            ...
            {
                throw new RenderException("VK_EXT_metal_surface extension not available.");
            }
        ...
        else
        {
            ...
            {
                throw new RenderException("vkCreateMacOSSurfaceMVK function not found.");
            }
